...
namespace CEmp
{
    ...
    public partial class fMain : Form
    {
        ...
        {
            g_sUserID = ClientUtils.UserPara1;//= "10001049";
            g_sProgram = ClientUtils.fProgramName;//= "Data Center";
            g_sFunction = ClientUtils.fFunctionName;//= "Employee";
        ...
        {
            sSQL = " Select a.* ,c.dept_name,d.shift_name "
        ...
        private void MenuRole_Click(object sender, EventArgs e)
        {
            ...
            fRole.g_sEmpName = sEmpName;
            fRole.g_sEmpID = sEmpID;
            fRole.ShowDialog();
        }
    }
}