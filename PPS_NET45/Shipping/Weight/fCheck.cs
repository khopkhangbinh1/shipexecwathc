...
namespace Weight
{
    public partial class fCheck : Form
    {
        ...
        private void password_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (CheckEmp(empNo, password_))
                {
                    ...
                    string strResult = wb.PPSCheckReprintRole(empNo, "WEIGHT",out strResultMsg);
        ...
        {
            if (string.IsNullOrEmpty(emp) || string.IsNullOrEmpty(psw))
            {
                return false;
            }
        ...
        //SELECT A.EMP_NAME FROM SAJET.SYS_EMP A
