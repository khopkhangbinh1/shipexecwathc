...
namespace Packingparcel.Wcf
{
    #region request model
    /// <summary>
    /// Ship Request Model
    /// </summary>
    public class ShipRequestModel : Credentials
    {
        /// <summary>
        /// 固定值：1
        /// </summary>
        ...
        /// fasle
        /// </summary>
        public string ShipWithoutTransaction { get => "false"; }
        /// <summary>
    ...
    public class PackageDefaults
    {
        ...
        /// 项目
        /// </summary>
        public string Terms { get => "SHIPPER"; }
        /// <summary>
        /// 第三方账单
        /// </summary>
        ...
        /// 打包
        /// </summary>
        public string Packaging { get => "CUSTOM"; }
