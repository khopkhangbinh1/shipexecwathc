...
namespace EDIWarehouseIN.WCF
{
    public class CommonModel
    {
        ...
        public class SNLIST
        {
            ...
            public string SNCOO { get; set; }
            public string SAPWH { get; set; }
        ...
        public class VNRAWINRETURNMODEL
        {
            public string INSN { get; set; }
            public string RESULT { get; set; }
            public string MSG { get; set; }
            public VNMATERIALQTY[] VNMATERIALQTY { get; set; }
        }

        public class VNMATERIALQTY
        {
            public string BOXID { get; set; }
            public string WO { get; set; }
            public string PALLETID { get; set; }
