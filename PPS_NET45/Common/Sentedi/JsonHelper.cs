...
namespace WikEasyUIDemo
{
    ...
    public class JsonHelper
    {
        ...
        /// <returns></returns>
        public static string CreateJsonParameters(DataTable dt, bool displayCount,string file_type)
        {
            return CreateJsonParameters(dt, displayCount, dt.Rows.Count, file_type);
        }
        /// <summary>
        /// 将DataTable中的数据转换成JSON格式
        /// </summary>
        /// <param name="dt">数据源DataTable</param>
        /// <returns></returns>
        public static string CreateJsonParameters(DataTable dt, string file_type)
        {
            return CreateJsonParameters(dt, true, file_type);
        }
        /// <summary>
        /// 将DataTable中的数据转换成JSON格式
        /// </summary>
        ...
        /// <returns></returns>
        public static string CreateJsonParameters(DataTable dt, bool displayCount, int totalcount, string file_type)
        {
            StringBuilder JsonString = new StringBuilder();
            //Exception Handling       
