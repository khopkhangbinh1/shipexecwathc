...
{
    public partial class FDConsolPLAMRLayoutCLForm
    {
        public string diskCompletePath = "";
        public FDConsolPLAMRLayoutCLForm(string shipID, bool print)
        {
        ...
        public void Initialize(string shipID, bool print)
        {
            ...
            string headerSql = @"select distinct a.SHIPID_TT,
                                ...
                                a.SE_ADDR2,
                                a.SE_ADDR3           
                                from WMUSER.AC_AMR_FD_CPL_CHI_HEADER@dgedi a,
            ...
            string lineSql = @"select t0.so_no as SHIPID_TT,
                                ...
                                WMUSER.AC_AMR_FD_CPL_CHI_LINE@dgedi t1,
                                ppsuser.g_ds_partinfo_t     d,
                                sajet.sys_part              e
            ...
            if (print)
            {
                Util.CreateDataTable(Constant.FDAMRCPLChileURL, ds);
            }
            else
            {
