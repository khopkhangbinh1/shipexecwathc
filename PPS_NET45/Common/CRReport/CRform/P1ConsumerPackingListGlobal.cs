...
{
    public partial class P1ConsumerPackingListGlobal
    {
        public P1ConsumerPackingListGlobal(string deliveryNo, string lineItem, string shipmentId, bool print)
        {
            Initialize(deliveryNo, lineItem, shipmentId, print, "");
        }

        public P1ConsumerPackingListGlobal(string deliveryNo, string lineItem, string shipmentId, bool print, string strPath)
        {
        ...
        public void Initialize(string deliveryNo, string lineItem, string shipmentId, bool print, string strPath)
        {
            ...
            if (print)
            {
                Util.CreateDataTable(Constant.P1ConsumerPackingListGlobal_URL, ds);
            }
            else
            {
                Util.printPDFCrystalReportV2(Constant.P1ConsumerPackingListGlobal_URL_ByGW, ds, strPath);
            }
        }


        public P1ConsumerPackingListGlobal(string deliveryNo, string lineItem, string shipmentId, string strCrystalFullPath, bool isCustom, bool isPDF, string strPDFPath, int nCopies, bool isOnlyGetDS, out DataSet dtCrystal, out string serverFullLabelName)
        {
        ...
        public void Initialize(string deliveryNo, string lineItem, string shipmentId, string strCrystalFullPath, bool isCustom, bool isPDF, string strPDFPath, int nCopies, bool isOnlyGetDS, out DataSet dtCrystal, out string serverFullLabelName)
        {
            ...
            if (string.IsNullOrEmpty(strCrystalFullPath))
            {
                ...
                {
                    strCrystalFullPath = Constant.P1ConsumerPackingListGlobal_URL;
                }
                else//isCustom如果是关务的是用宋体的模板 
                {
                    strCrystalFullPath = Constant.P1ConsumerPackingListGlobal_URL_ByGW;
                }
            }
        ...
        public P1ConsumerPackingListGlobal(string deliveryNo, string lineItem)
        {
            ...
            string headerSql = string.Format(@" select distinct  a.shiptoname as ST_NAME,
                                                 ...
                                                 FROM pptest.oms_940_m omm WHERE omm.ac_dn='{0}') as SHIP_DATE, 
                                                   ...
                                                   from ppsuser.t_940_unicode   a
                                                            ...
                                                            and   a.custdelitem = '{1}' ", deliveryNo, lineItem);
