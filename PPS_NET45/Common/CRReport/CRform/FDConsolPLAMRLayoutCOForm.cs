...
{
    public partial class FDConsolPLAMRLayoutCOForm
    {
        public string diskCompletePath = "";
        public FDConsolPLAMRLayoutCOForm(string shipID, bool print)
        {
        ...
        public void Initialize(string shipID, bool print)
        {
            ...
            string headerSql = @"select distinct a.SHIPID_TT,
                                ...
                                a.DECLAR,
                                a.DN           
                                from WMUSER.AC_AMR_FD_CPL_COL_HEADER@dgedi a,
            ...
            string lineSql = @"select t0.so_no as SHIPID_TT,
                                ...
                                WMUSER.AC_AMR_FD_CPL_COL_LINE@dgedi t1,
                                ppsuser.g_ds_partinfo_t     d,
                                sajet.sys_part              e
            ...
            string tmp = "";
            tmp = Application.StartupPath + "\\PDF\\" + shipID + "FDConsolPLAMRColumbia.pdf";
            diskCompletePath = tmp; //全局变量返回pdf路径
            if (print)
            {
                Util.CreateDataTable(Constant.FDAMRCPLColumbia_URL, ds);
            }
            else
            {
