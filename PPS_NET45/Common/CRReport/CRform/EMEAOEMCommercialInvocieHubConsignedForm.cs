...
{
    public partial class EMEAOEMCommercialInvocieHubConsignedForm
    {
        public EMEAOEMCommercialInvocieHubConsignedForm(string shipID, string diskPath, bool print)
        {
        ...
        private void Initialize(string shipID, string diskPath, bool print)
        {
            ...
            String filePath = "";
            filePath = diskPath + shipID + "EMEAOEMCommercialHubConsigned.pdf";
            if (print)
            {
                Util.CreateDataTable(Constant.EMEACommercialHub_URL, ds);
            }
            else
            {
                Util.exportCRPDFAndSendEmail(Constant.EMEACommercialHub_URL, ds, filePath);
            }
        }
    }
}
