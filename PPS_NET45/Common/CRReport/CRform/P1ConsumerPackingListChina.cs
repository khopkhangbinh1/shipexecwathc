...
namespace CRReport.CRfrom
{
     ...
     *                 */
    public partial class P1ConsumerPackingListChina
    {
        public P1ConsumerPackingListChina(string deliveryNo, string lineItem, string shipmentId, bool print)
        {
            initialize(deliveryNo, lineItem, shipmentId, print, "");
        }

        public P1ConsumerPackingListChina(string deliveryNo, string lineItem, string shipmentId, bool print, string strPath)
        {
        ...
        public void initialize(string deliveryNo, string lineItem, string shipmentId, bool print, string strPath)
        {
            ...
            if (print)
            {
                Util.CreateDataTable(Constant.P1ConsumerPackingListChina_URL, ds);
            }
            else
            {
                Util.printPDFCrystalReportV2(Constant.P1ConsumerPackingListChina_URL_ByGW, ds, strPath);
            }
        }


        public P1ConsumerPackingListChina(string deliveryNo, string lineItem, string shipmentId, string strCrystalFullPath, bool isCustom, bool isPDF, string strPDFPath, int nCopies, bool isOnlyGetDS, out DataSet dtCrystal, out string serverFullLabelName)
        {
        ...
        public void initialize(string deliveryNo, string lineItem, string shipmentId, string strCrystalFullPath, bool isCustom, bool isPDF, string strPDFPath, int nCopies, bool isOnlyGetDS, out DataSet dtCrystal, out string serverFullLabelName)
        {
            ...
            if (string.IsNullOrEmpty(strCrystalFullPath))
            {
                ...
                {
                    strCrystalFullPath = Constant.P1ConsumerPackingListChina_URL;
                }
                else//isCustom如果是关务的是用宋体的模板 
                {
                    strCrystalFullPath = Constant.P1ConsumerPackingListChina_URL_ByGW;
                }
            }
        ...
        public P1ConsumerPackingListChina(string deliveryNo, string lineItem)
        {
