...
{
    public partial class MexicoChannelPackingList
    {
        public string completeDiskPath = "";
        public MexicoChannelPackingList(string acDn, string lineItem, string shipmentId, bool print, string diskPath)
        {
...
", acDn, lineItem, shipmentId);
            ...
            if (print)
            {
                Util.CreateDataTable(Constant.CHANNELUS_URL, ds);
            }
            else
            {
        ...
        public MexicoChannelPackingList(string acDn, string lineItem, string shipmentId, string strCrystalFullPath, bool isCustom, bool isPDF, string strPDFPath, int nCopies, bool isOnlyGetDS, out DataSet dtCrystal, out string serverFullLabelName)
        {
