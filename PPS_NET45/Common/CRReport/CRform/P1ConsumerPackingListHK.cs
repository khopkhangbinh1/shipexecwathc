...
{
    public partial class P1ConsumerPackingListHK
    {
        public P1ConsumerPackingListHK(string deliveryNo, string lineItem, string shipmentId, bool print)
        {
            Initialize(deliveryNo, lineItem, shipmentId, print, "");
        }

        public P1ConsumerPackingListHK(string deliveryNo, string lineItem, string shipmentId, bool print, string strPath)
        {
        ...
        public void Initialize(string deliveryNo, string lineItem, string shipmentId, bool print, string strPath)
        {
            ...
            if (print)
            {
                Util.CreateDataTable(Constant.P1ConsumerPackingListHongKong_URL, ds);

            }
            else
            {
                Util.printPDFCrystalReportV2(Constant.P1ConsumerPackingListHongKong_URL_ByGW, ds, strPath);
            }
        ...
        public P1ConsumerPackingListHK(string deliveryNo, string lineItem, string shipmentId, string strCrystalFullPath, bool isCustom, bool isPDF, string strPDFPath, int nCopies, bool isOnlyGetDS, out DataSet dtCrystal, out string serverFullLabelName)
        {
        ...
        public void Initialize2(string deliveryNo, string lineItem, string shipmentId, string strCrystalFullPath, bool isCustom, bool isPDF, string strPDFPath, int nCopies, bool isOnlyGetDS, out DataSet dtCrystal, out string serverFullLabelName)
        {
            ...
            if (string.IsNullOrEmpty(strCrystalFullPath))
            {
                ...
                {
                    strCrystalFullPath = Constant.P1ConsumerPackingListHongKong_URL;
                }
                else//isCustom如果是关务的是用宋体的模板 
                {
                    strCrystalFullPath = Constant.P1ConsumerPackingListHongKong_URL_ByGW;
                }
            }
        ...
        public P1ConsumerPackingListHK(string deliveryNo, string lineItem)
        {
