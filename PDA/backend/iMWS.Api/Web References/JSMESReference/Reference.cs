...
namespace iMWS.Api.JSMESReference {
    using System;
    ...
    public partial class MesApi : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback DNHoldOperationCompleted;
        ...
        /// <remarks/>
        public event DNHoldCompletedEventHandler DNHoldCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org.bill/DNHold", RequestNamespace="http://tempuri.org.bill/", ResponseNamespace="http://tempuri.org.bill/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string DNHold(string json) {
            object[] results = this.Invoke("DNHold", new object[] {
                        json});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void DNHoldAsync(string json) {
            this.DNHoldAsync(json, null);
        }
        
        /// <remarks/>
        public void DNHoldAsync(string json, object userState) {
            if ((this.DNHoldOperationCompleted == null)) {
                this.DNHoldOperationCompleted = new System.Threading.SendOrPostCallback(this.OnDNHoldOperationCompleted);
            }
            this.InvokeAsync("DNHold", new object[] {
                        json}, this.DNHoldOperationCompleted, userState);
        }
        
        private void OnDNHoldOperationCompleted(object arg) {
            if ((this.DNHoldCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.DNHoldCompleted(this, new DNHoldCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void DNHoldCompletedEventHandler(object sender, DNHoldCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class DNHoldCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal DNHoldCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
