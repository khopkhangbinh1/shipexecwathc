...
namespace RemoteService
{
    ...
    public interface IRemoteServiceObject
    {
        ...
        [OperationContract]
        int RowCount(string sSQL, Dictionary<string, object> param);
        ...
        [OperationContract]
        string ExecuteQuery(string sql,Dictionary<string,object> obj);

        [OperationContract]
        string DoTransaction(Dictionary<string, string> obj);
        [OperationContract]
        string DoExtremeSpeedTransaction(Dictionary<string, string> trans);

        [OperationContract]
        string DoExtremeSpeedTransactionByDbType(string sModel);
